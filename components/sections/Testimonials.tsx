...
const testimonials = [
  {
    ...
    content: "Xaurum Academy transformed my approach to JEE preparation. The faculty's depth of knowledge, especially Dr. Rajesh Kumar's Physics classes, was unparalleled. I went from scoring 60 percentile to AIR 247 in just one year of dedicated study here.",
    rating: 5,
    exam: "JEE Advanced",
  ...
  },
  {
    ...
    content: "I got a perfect score in NEET and it would not have been possible without Xaurum Academy. Dr. Priya Das's Biology sessions were phenomenal. The study material and mock tests exactly replicated real exam conditions, which built my confidence tremendously.",
    rating: 5,
    exam: "NEET",
    college: "AIIMS Delhi",
  ...
  },
  {
    ...
    content: "The personalized attention I received at Xaurum Academy was incredible. Small batch sizes meant teachers actually knew my weak areas. The weekly tests and detailed analysis helped me continuously improve. Very grateful for the mentorship.",
    rating: 5,
    exam: "WBJEE",
  ...
  },
  {
    ...
    content: "I was struggling with Chemistry until I joined Xaurum Academy. The faculty's teaching methodology made complex organic chemistry so easy to understand. My scores improved from 68% to 98.6% in board exams. Highly recommend!",
    rating: 5,
    exam: "WBCHSE",
